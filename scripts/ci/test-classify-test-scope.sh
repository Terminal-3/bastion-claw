...
assert_scope \
  "reborn binary crate" \
  "crates/t3claw_reborn_cli/src/main.rs" \
  "docs_only=false
has_core_code=true
...
assert_scope \
  ...
  "crates/t3claw_product_workflow_storage/src/lib.rs" \
  "docs_only=false
has_core_code=true
has_legacy_tests=false
has_reborn_tests=true"
...
assert_scope \
  ...
  "crates/t3claw_telegram_v2_adapter/src/lib.rs" \
  "docs_only=false
has_core_code=true
has_legacy_tests=false
has_reborn_tests=true"
...
assert_scope \
  ...
  "crates/t3claw_outbound/src/lib.rs" \
  "docs_only=false
has_core_code=true
has_legacy_tests=false
has_reborn_tests=true"
...
assert_scope \
  ...
  "crates/t3claw_host_runtime/src/lib.rs" \
  "docs_only=false
has_core_code=true
has_legacy_tests=true
has_reborn_tests=true"
...
assert_scope \
  ...
  "src/agent/session.rs
crates/t3claw_reborn_composition/src/lib.rs" \
  "docs_only=false
has_core_code=true
has_legacy_tests=true
has_reborn_tests=true"
