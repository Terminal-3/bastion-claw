...
//! `crates/t3claw_skills/src/selector.rs::tests::test_setup_marker_*`
//! and the v2 equivalent in
//! `crates/t3claw_engine/src/executor/orchestrator.rs::handle_list_skills`.
//!
...
"#
    ...
    fn marker_occurrences(requests: &[Vec<t3claw_llm::ChatMessage>]) -> usize {
        let mut count = 0;
