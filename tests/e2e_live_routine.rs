...
//! ```bash
//! T3CLAW_LIVE_TEST=1 cargo test --features libsql --test e2e_live_routine -- --ignored
//! ```
//!
...
mod live_routine_tests {
    ...
    /// is back. Source: `crates/t3claw_engine/orchestrator/default.py:1003`.
    ...
    async fn routine_btc_create_test_and_refire() {
        ...
        // `crates/t3claw_engine/src/gate/tool_tier.rs` does not appear
