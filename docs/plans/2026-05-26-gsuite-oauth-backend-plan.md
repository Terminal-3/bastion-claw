...
- OAuth ownership stays in `t3claw_auth`; no new product-facing `t3claw_oauth` crate.
- GSuite stays in `t3claw_first_party_extensions`; no resurrection of the older `t3claw_native_extensions` plan.
