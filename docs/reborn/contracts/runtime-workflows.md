# T3Claw Reborn runtime workflow ownership contract
...
This prevents a new hidden agent runtime from forming inside `t3claw_kernel`, `t3claw_extensions`, or a future conversation crate.
