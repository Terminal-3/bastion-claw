# T3Claw Reborn script runner contract

**Date:** 2026-04-25
**Status:** V1 contract slice
**Crate:** `crates/t3claw_scripts`
...
`t3claw_scripts` provides the native CLI/software execution lane without requiring every useful tool to be rebuilt in WASM.
...
`t3claw_dispatcher` selects the script lane when a declared capability has:
