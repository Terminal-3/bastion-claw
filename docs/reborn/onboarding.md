...
```json
{
  "schema_version": "t3claw.reborn.onboarding/v1",
  "completed_at": "RFC3339 timestamp",
  "reborn_home": "/absolute/path",
  "home_source": "T3CLAW_REBORN_HOME or default",
...
- No automatic first-run invocation before `t3claw-reborn run`.
...
1. add an interactive prompt layer under `crates/t3claw_reborn_cli`;
