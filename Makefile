...
.PHONY: up build rebuild up-no-t3n build-no-t3n rebuild-no-t3n build-sidecar rebuild-sidecar pull-sidecar down wipe wipe-all restart logs shell status help
