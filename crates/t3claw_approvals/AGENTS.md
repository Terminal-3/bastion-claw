...
- Note: the durable approval *request records* are owned by `t3claw_run_state`; this crate consumes them and produces the lease/denial decision.
...
- Fast local check: `cargo test -p t3claw_approvals`
