# Agent Map - t3claw_event_streams
...
- Use these Reborn contracts before changing behavior:
  ...
  - `crates/t3claw_event_projections/AGENTS.md`
...
- Fast local check: `cargo test -p t3claw_event_streams --locked`
- Boundary check after dependency/API changes: `cargo test -p t3claw_architecture reborn --locked`
- Run `cargo clippy -p t3claw_event_streams --all-targets -- -D warnings` before requesting review.
