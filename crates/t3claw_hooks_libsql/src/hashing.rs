...
//! ([`t3claw_hooks::predicate_hash`]) so the durable DB identity contract has
...
//!
//! [`Digest`]: t3claw_hooks::predicate_hash::Digest

use chrono::{DateTime, Utc};
use t3claw_hooks::predicate_hash;
use t3claw_hooks::predicate_state::{InvocationKey, ValueKey, window_cutoff};
...
/// [`t3claw_hooks::predicate_state::window_cutoff`] so the overflow/boundary
