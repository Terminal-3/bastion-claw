...
//! (`t3claw_hooks::predicate_state::InMemoryPredicateStateBackend`) against a
...
//!
//! [`PredicateStateBackend`]: t3claw_hooks::predicate_state::PredicateStateBackend
//!
...
//!
//! [`MAX_SAMPLES_PER_KEY`]: t3claw_hooks::predicate_state::MAX_SAMPLES_PER_KEY
//! [`PredicateBackendError::WindowOverflow`]: t3claw_hooks::predicate_state::PredicateBackendError::WindowOverflow
//!
...
/// `t3claw_hooks/docs/successors/03-persistent-counter.md` (Reaper
...
///
/// [`MAX_HISTORY_KEYS`]: t3claw_hooks::predicate_state::MAX_HISTORY_KEYS
/// [`MAX_KEYS_PER_TENANT`]: t3claw_hooks::predicate_state::MAX_KEYS_PER_TENANT
/// [`PredicateStateBackend::evict_older_than`]: t3claw_hooks::predicate_state::PredicateStateBackend::evict_older_than
