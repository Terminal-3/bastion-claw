//! Resource reservation governor for T3Claw Reborn.
//!
//! `t3claw_resources` enforces the host-level reservation protocol used by
...
//! over a [`ScopedFilesystem`](t3claw_filesystem::ScopedFilesystem). The
