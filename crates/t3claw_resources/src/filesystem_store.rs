...
//! [`MountView`](t3claw_host_api::MountView) and route every
...
//! [`ScopedFilesystem`](t3claw_filesystem::ScopedFilesystem) mount
...
/// tenant/user-scoped [`VirtualPath`](t3claw_host_api::VirtualPath)
/// per its [`MountView`](t3claw_host_api::MountView) and enforces
