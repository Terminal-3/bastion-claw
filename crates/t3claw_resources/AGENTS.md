...
- Reservation/receipt vocabulary `ResourceReservation` / `ResourceReceipt`, re-exported from `t3claw_host_api`.
...
- Fast local check: `cargo test -p t3claw_resources`
