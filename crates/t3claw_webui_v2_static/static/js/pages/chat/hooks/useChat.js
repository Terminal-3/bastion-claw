...
const OAUTH_CALLBACK_CHANNEL = "t3claw-product-auth";
const OAUTH_CALLBACK_STORAGE_KEY = "t3claw:product-auth:oauth-complete";
const OAUTH_CALLBACK_MESSAGE_TYPE = "t3claw:product-auth:oauth-complete";
