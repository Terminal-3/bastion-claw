...
registerPack("en", {
  ...
  // Chat — input
  "chat.placeholder": "Message T3Claw...",
  "chat.heroPlaceholder": "Ask T3Claw anything.",
  ...
  "onboarding.title": "Welcome to T3Claw",
  ...
  "projects.empty.noneDesc":
    "Projects appear once the assistant creates durable workspaces. You can start from chat and ask T3Claw to spin up a scoped project for ongoing work.",
