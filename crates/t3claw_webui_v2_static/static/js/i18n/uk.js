...
registerPack("uk", {
  ...
  // Chat — input
  "chat.placeholder": "Напишіть T3Claw…",
  "chat.heroPlaceholder": "Запитайте T3Claw про що завгодно.",
  ...
  // Restart dialog
  "restart.title": "Перезапустити T3Claw",
  ...
  "restart.progressTitle": "Перезапуск T3Claw",
  ...
  "onboarding.title": "Ласкаво просимо до T3Claw",
  ...
  "projects.empty.noneDesc": "Проєкти з’являються, коли асистент створює довговічні робочі простори. Ви можете почати з чату й попросити T3Claw створити проєкт для тривалої роботи.",
