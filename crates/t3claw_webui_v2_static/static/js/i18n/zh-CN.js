...
registerPack("zh-CN", {
  ...
  // Chat — input
  "chat.placeholder": "给 T3Claw 发消息...",
  "chat.heroPlaceholder": "向 T3Claw 提问。",
  ...
  "projects.empty.noneDesc": "当助手创建持久化工作区后，项目就会出现。你可以从聊天开始，并让 T3Claw 为持续工作创建一个范围项目。",
