...
registerPack("ja", {
  ...
  // Chat — input
  "chat.placeholder": "T3Claw にメッセージ…",
  "chat.heroPlaceholder": "T3Claw に何でも聞いてください。",
  ...
  "restart.progressTitle": "T3Claw の再起動",
  ...
  "projects.empty.noneDesc": "アシスタントが永続ワークスペースを作成するとプロジェクトが表示されます。チャットから開始し、継続作業のためのプロジェクト作成をT3Clawに依頼できます。",
