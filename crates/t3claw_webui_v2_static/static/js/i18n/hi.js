...
registerPack("hi", {
  ...
  // Chat — input
  "chat.placeholder": "T3Claw को संदेश...",
  "chat.heroPlaceholder": "T3Claw से कुछ भी पूछें.",
  ...
  // Restart dialog
  "restart.title": "T3Claw पुनरारंभ करें",
  ...
  "restart.progressTitle": "T3Claw को पुनरारंभ करना",
  ...
  "onboarding.title": "T3Claw में आपका स्वागत है",
  ...
  "projects.empty.noneDesc": "जब असिस्टेंट ड्यूरेबल वर्कस्पेस बनाता है तब प्रोजेक्ट दिखाई देते हैं। आप चैट से शुरू कर सकते हैं और T3Claw से जारी काम के लिए स्कोप्ड प्रोजेक्ट बनाने को कह सकते हैं।",
