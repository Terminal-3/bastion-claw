...
// `t3claw_reborn_webui_ingress::webui_v2_auth_router`, or a
...
// `t3claw_product_workflow::webui_inbound` and
// `t3claw_product_workflow::reborn_services::types`. The error
// envelope mirrors `RebornServicesError`.

const TOKEN_KEY = "t3claw_token";
...
// `t3claw_reborn_webui_ingress` at the same origin as the SPA. The
