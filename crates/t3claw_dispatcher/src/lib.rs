//! Composition-only runtime dispatch contracts for T3Claw Reborn.
//!
//! `t3claw_dispatcher` wires validated extension descriptors to runtime lanes. It
...
use t3claw_events::{EventSink, RuntimeEvent};
...
use t3claw_resources::ResourceGovernor;
...
// Removed: dispatch_error_kind was a local copy of DispatchError::event_kind() from t3claw_host_api.
