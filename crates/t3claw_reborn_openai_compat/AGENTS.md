# Agent Map — t3claw_reborn_openai_compat
...
- v1 gateway fallbacks or direct `t3claw_llm` proxy behavior.

## Validation

- `cargo test -p t3claw_reborn_openai_compat --features openai-compat-beta`
- `cargo clippy -p t3claw_reborn_openai_compat --all-targets --all-features -- -D warnings`
