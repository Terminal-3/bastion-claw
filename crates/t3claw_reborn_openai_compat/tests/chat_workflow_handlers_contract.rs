...
use t3claw_turns::{AcceptedMessageRef, TurnActor, TurnRunId, TurnScope};
...
impl ProductWorkflow for FixedAckWorkflow {
    ...
    ) -> Result<ProjectionReadRequest, t3claw_product_adapters::ProductAdapterError> {
        self.read_inputs
            .lock()
...
impl OpenAiChatCompletionProjectionReader for StaticChatProjectionReader {
    ...
    ) -> Result<OpenAiChatCompletionProjection, t3claw_reborn_openai_compat::OpenAiCompatHttpError>
    {
