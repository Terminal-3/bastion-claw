...
use serde_json::json;
use t3claw_host_api::{TenantId, ThreadId, UserId};
...
impl ProductWorkflow for FixedAckWorkflow {
    ...
    ) -> Result<ProductInboundAck, t3claw_product_adapters::ProductAdapterError> {
        self.seen_envelopes
            .lock()
    ...
    ) -> Result<ProjectionSubscriptionRequest, t3claw_product_adapters::ProductAdapterError> {
...
impl OpenAiResponsesProjectionReader for StaticResponsesReader {
    ...
    ) -> Result<t3claw_reborn_openai_compat::OpenAiResponseProjection, OpenAiCompatHttpError> {
        Ok(t3claw_reborn_openai_compat::OpenAiResponseProjection::new(
...
fn completed_response(public_id: OpenAiResponseId, text: &str) -> OpenAiResponseObject {
    OpenAiResponseObject {
        ...
        usage: Some(t3claw_reborn_openai_compat::OpenAiResponseUsage {
            input_tokens: 1,
