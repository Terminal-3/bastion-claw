...
use t3claw_events::{EventLogEntry, RuntimeEvent, RuntimeEventKind, sanitize_error_kind};
...
fn compare_projection_order(
    left_updated_at: &t3claw_host_api::Timestamp,
    right_updated_at: &t3claw_host_api::Timestamp,
    left_cursor: t3claw_events::EventCursor,
    right_cursor: t3claw_events::EventCursor,
