...
//! implementation is replay-derived over [`t3claw_events::DurableEventLog`]
...
use t3claw_turns::EventCursor as TurnEventCursor;
use thiserror::Error;

pub use t3claw_events::EventCursor;
...
pub struct TimelineEntry {
    ...
    pub event_id: t3claw_events::RuntimeEventId,
