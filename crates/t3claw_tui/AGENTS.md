...
- Fast local check: `cargo test -p t3claw_tui`
...
- Keep the crate independent from the main `t3claw` crate; bridge integration belongs in `src/channels/tui.rs`.
