//! Loop support services for T3Claw Reborn.
//!
...
pub use t3claw_turns::run_profile::PromptContextTokenBudget;
...
#[async_trait]
impl t3claw_turns::run_profile::LoopCapabilityPort for EmptyLoopCapabilityPort {
    ...
    G: HostManagedModelGateway + ?Sized + Send + Sync,
{
    ...
    async fn load_model_context_window(
        &self,
    ) -> Result<t3claw_threads::ContextWindow, AgentLoopHostError> {
        if let Some(cache) = self.context_window_cache.as_ref()
...
/// snapshot DTO here.
pub type HostManagedModelRouteSnapshot = t3claw_turns::run_profile::LoopModelRouteSnapshot;
...
impl HostManagedModelResponse {
    ...
    pub fn capability_calls(
        calls: Vec<t3claw_turns::run_profile::CapabilityCallCandidate>,
...
fn provider_call_reference_to_envelope(
    provider_call: t3claw_turns::run_profile::ProviderToolCallReference,
