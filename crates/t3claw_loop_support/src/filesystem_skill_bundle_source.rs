...
use t3claw_filesystem::{FileType, FilesystemError, RootFilesystem, ScopedFilesystem};
use t3claw_host_api::{ResourceScope, ScopedPath, TenantId};
use t3claw_skills::{
...
mod tests {
    ...
    async fn filesystem_source_downgrades_url_installed_user_bundle_metadata() {
        ...
        write_root(
            &root,
            "/tenants/tenant-a/users/user-a/skills/remote-review/.t3claw-install.json",
