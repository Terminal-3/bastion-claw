...
use t3claw_safety::{InjectionScanner, LeakDetector, LeakScanner, Sanitizer};
use t3claw_threads::{
...
fn compaction_message_body(
    message: &t3claw_threads::ThreadMessageRecord,
...
mod tests {
    use super::*;
    use t3claw_threads::{ThreadMessageId, ThreadMessageRecord};
