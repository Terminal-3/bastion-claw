...
- Depend only on neutral substrate crates such as `t3claw_host_api`; runtime, host composition, authorization, approvals, networking, and persistence live in their owning crates.
