...
struct HostedMcpCapabilityTemplate {
    ...
    required_host_ports: Vec<t3claw_host_api::HostPortId>,
    runtime_credentials: Vec<t3claw_host_api::RuntimeCredentialRequirement>,
    resource_profile: Option<t3claw_host_api::ResourceProfile>,
}
...
mod tests {
    ...
    use t3claw_host_api::{EffectKind, RuntimeKind, VirtualPath};
