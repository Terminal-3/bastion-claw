# t3claw_product_adapters guardrails

Owns the product-surface adapter boundary for T3Claw Reborn (issue #3269).
...
- Stay above the kernel/dispatcher layer. Do **not** depend on or re-export
  ...
  `t3claw_turns::runner` trusted transition APIs. Boundary tests in
