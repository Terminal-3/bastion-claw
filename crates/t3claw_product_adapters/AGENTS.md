# Agent Map — t3claw_product_adapters
...
- Use these neighboring contracts before changing behavior:
  - `crates/t3claw_product_adapter_registry/AGENTS.md`
  - `crates/t3claw_product_workflow/AGENTS.md`
  - `crates/t3claw_wasm_product_adapters/CLAUDE.md`
  - `crates/t3claw_outbound/AGENTS.md`
...
- Fast local check: `cargo test -p t3claw_product_adapters`
- Contract checks: `cargo test -p t3claw_product_adapters --test product_adapter_contract`
- Review-regression checks: `cargo test -p t3claw_product_adapters --test review_findings_contract`
