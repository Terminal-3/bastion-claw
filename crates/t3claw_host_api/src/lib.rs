//! Shared host API contracts for T3Claw Reborn.
//!
//! `t3claw_host_api` is the vocabulary every Reborn system-service crate uses
...
// `t3claw_host_api` as a contract prelude, while module docs remain the
