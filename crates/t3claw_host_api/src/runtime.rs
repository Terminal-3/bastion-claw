...
//! effective trust must go through the host policy engine in `t3claw_trust`;
...
/// and `System` should only be produced by `t3claw_trust::TrustPolicy`. The
...
/// must consume `t3claw_trust::EffectiveTrustClass`, whose privileged
