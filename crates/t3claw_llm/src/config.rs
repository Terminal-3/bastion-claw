...
use t3claw_common::paths::t3claw_base_dir;
...
impl NearAiConfig {
    ...
    pub(crate) fn for_model_discovery() -> Self {
        let api_key = t3claw_common::env_helpers::env_or_override("NEARAI_API_KEY")
            .filter(|k| !k.is_empty())
        ...
        let base_url = t3claw_common::env_helpers::env_or_override("NEARAI_BASE_URL")
