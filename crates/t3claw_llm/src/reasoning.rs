...
use t3claw_common::provider_transcript::strip_provider_transcript_artifact_lines;
...
pub struct Reasoning {
    ...
    platform_info: Option<t3claw_common::PlatformInfo>,
}
...
impl Reasoning {
    ...
    pub fn with_platform_info(mut self, info: t3claw_common::PlatformInfo) -> Self {
