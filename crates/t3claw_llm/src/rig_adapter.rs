...
fn extract_response(
    ...
    for content in choice.iter() {
        match content {
            ...
            // Image variants are not mapped to T3Claw types
            _ => {}
        }
    }
...
mod tests {
    ...
    /// reasoning round-trip *inside* rig-core. T3Claw's RigAdapter sits
    ...
    /// T3Claw conversion. On the next request it rebuilt rig messages
    ...
    ///   2. round-trip those onto an T3Claw `ChatMessage`
    ...
    fn reasoning_and_signature_round_trip_through_chat_message() {
        ...
        // --- T3Claw stores the assistant message + tool result ---
        ...
        // --- Turn 2: T3Claw rebuilds the rig request from stored messages ---
        let messages = vec![
