//! Docker process sandbox process executor for T3Claw Reborn.
//!
...
pub const DEFAULT_PROCESS_SANDBOX_IMAGE: &str = "t3claw-process-sandbox:dev";
pub const PROCESS_SANDBOX_CAPABILITY_ID: &str = "system.process_sandbox.run";
pub const DEFAULT_WORKSPACE_MOUNT: &str = "/workspace";
pub const DEFAULT_TOOLS_MOUNT: &str = "/t3claw/state/tools";
pub const DEFAULT_CACHE_MOUNT: &str = "/t3claw/state/cache";
