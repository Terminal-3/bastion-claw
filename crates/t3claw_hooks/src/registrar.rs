...
impl HookRegistrar {
    ...
    pub fn install(
        ...
        // (`t3claw_reborn_composition`) replays the same validated install
...
mod tests {
    ...
    fn extension() -> t3claw_host_api::ExtensionId {
        t3claw_host_api::ExtensionId::new("polymarket-trader").expect("valid extension id")
    }
...
"#;
    ...
    async fn installer_propagates_owning_extension_and_scope_from_manifest() {
        ...
        let host_extension =
            t3claw_host_api::ExtensionId::new("polymarket-trader").expect("valid ext id");
