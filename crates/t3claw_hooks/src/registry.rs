...
//! `t3claw_turns::run_profile` and the extension installer.

use std::collections::HashMap;

use serde::{Deserialize, Serialize};
use t3claw_events::RuntimeEventKind;
...
mod tests {
    ...
    fn rejects_own_capabilities_at_before_prompt() {
        ...
        binding.owning_extension = Some(t3claw_host_api::ExtensionId::new("ext").expect("valid"));
