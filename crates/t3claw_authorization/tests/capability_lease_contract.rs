...
async fn filesystem_capability_lease_store_writes_tenant_id_indexed_projection() {
    ...
    let owner_alias = t3claw_host_api::ScopedPath::new(format!(
...
impl RootFilesystem for CountingFilesystem {
    ...
    async fn put(
        &self,
        path: &VirtualPath,
        entry: t3claw_filesystem::Entry,
        cas: t3claw_filesystem::CasExpectation,
    ) -> Result<t3claw_filesystem::RecordVersion, FilesystemError> {
