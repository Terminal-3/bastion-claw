...
- Keep MCP protocol concerns here; extension discovery belongs in `t3claw_extensions`, network enforcement in `t3claw_network`/host runtime egress, and product workflow outside this crate.
