//! Shared OAuth callback infrastructure used by every T3Claw OAuth flow
...
pub fn callback_url() -> String {
    t3claw_common::env_helpers::env_or_override("T3CLAW_OAUTH_CALLBACK_URL")
...
pub fn callback_host() -> String {
    t3claw_common::env_helpers::env_or_override("OAUTH_CALLBACK_HOST")
...
mod tests {
    use super::*;
    use t3claw_common::env_helpers::lock_env;
