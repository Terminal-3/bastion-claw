...
use t3claw_product_adapters::{ProductOutboundEnvelope, ProjectionCursor};
use t3claw_threads::{SessionThreadRecord, SummaryArtifact, ThreadMessageRecord};
use t3claw_turns::{
...
/// canonical [`t3claw_turns::TurnScope`] inside the facade.
#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
