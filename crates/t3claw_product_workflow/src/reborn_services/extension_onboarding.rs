    ...
    fn github_manual_token_projects_setup_required_message() {
        let extension = installed_extension(
            ...
            Some(LifecycleExtensionOnboarding {
                ...
                credential_instructions: Some("Create a GitHub personal access token with the repository permissions you want T3Claw to use, then paste it here.".to_string()),
        ...
        let extension = installed_extension(
            ...
            Some(LifecycleExtensionOnboarding {
                ...
                credential_instructions: Some(
                    "Authorize the Google account that T3Claw should use for Gmail.".to_string(),
                ),
                setup_url: None,
