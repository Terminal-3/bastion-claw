...
use t3claw_product_adapters::{ProductAdapterError, ProductWorkflowRejectionKind, RedactedString};
use t3claw_turns::{TurnError, TurnErrorCategory};
use thiserror::Error;
...
pub enum ProductWorkflowError {
    ...
    DuplicateAction {
        prior_outcome: t3claw_product_adapters::ProductInboundAck,
    },
