...
use t3claw_product_adapters::ProductWorkflowRejectionKind;
use t3claw_turns::{CancelRunResponse, GateRef, IdempotencyKey, ResumeTurnResponse, TurnActor};
...
pub struct AuthInteractionScope {
    pub tenant_id: t3claw_host_api::TenantId,
    pub user_id: t3claw_host_api::UserId,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub agent_id: Option<t3claw_host_api::AgentId>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub project_id: Option<t3claw_host_api::ProjectId>,
    pub thread_id: t3claw_host_api::ThreadId,
}
...
pub enum AuthInteractionChallengeView {
    ...
    ManualTokenRequired {
        interaction_id: t3claw_auth::AuthInteractionId,
        provider: t3claw_auth::AuthProviderId,
        expires_at: Timestamp,
    },
...
pub struct PendingAuthInteractionView {
    ...
    pub provider: t3claw_auth::AuthProviderId,
    pub summary: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
