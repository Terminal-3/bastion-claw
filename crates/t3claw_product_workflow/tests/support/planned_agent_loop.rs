...
use t3claw_host_runtime::{CapabilitySurfacePolicy, SurfaceKind};
...
use t3claw_trust::EffectiveTrustClass;
use t3claw_turns::{
...
impl ProductLiveAgentLoopHarness {
    ...
    ) -> Result<InboundTurnOutcome, t3claw_product_workflow::ProductWorkflowError> {
        ...
        grants: capabilities
            ...
            .map(|capability| CapabilityGrant {
                ...
                constraints: GrantConstraints {
                    ...
                    mounts: t3claw_host_api::MountView::default(),
