# Agent Map — t3claw_product_workflow
...
- Fast local check: `cargo test -p t3claw_product_workflow`
- Lint check: `cargo clippy -p t3claw_product_workflow --all-targets -- -D warnings`
...
- User-message acceptance must persist canonical thread content through `t3claw_threads::SessionThreadService` before turn submission.
