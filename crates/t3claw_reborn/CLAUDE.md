...
- `planned_driver.rs` adapts `t3claw_agent_loop` families and executor to the
...
- `t3claw_agent_loop` owns loop families and executor behavior.
- `t3claw_turns` owns runner and host contracts.
- `t3claw_loop_support` owns reusable host-port adapters.
