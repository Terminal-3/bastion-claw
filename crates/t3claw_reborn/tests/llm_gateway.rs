...
use t3claw_host_api::{AgentId, CapabilityId, ProjectId, TenantId, ThreadId, UserId};
use t3claw_llm::{
...
use t3claw_reborn::model_gateway::{
...
async fn provider_pool_rejects_wrong_provider_identity_with_same_model() {
    ...
    let key = t3claw_reborn::model_routes::ModelRouteProviderKey::for_route(route);
...
impl HostManagedModelGateway for InvalidSummaryModelGateway {
    async fn stream_model(
        ...
        t3claw_loop_support::HostManagedModelError,
    > {
        Err(t3claw_loop_support::HostManagedModelError::safe(
            self.kind,
...
impl LoopCapabilityPort for GatewayCapabilityPort {
    fn tool_definitions(
        &self,
    ) -> Result<Vec<ProviderToolDefinition>, t3claw_turns::run_profile::AgentLoopHostError> {
    ...
    fn validate_provider_tool_call(
        ...
        let arguments_len = serde_json::to_vec(&tool_call.arguments)
            .map_err(|error| {
                t3claw_turns::run_profile::AgentLoopHostError::new(
                    AgentLoopHostErrorKind::InvalidInvocation,
                    error.to_string(),
                )
            })?
    ...
    async fn register_provider_tool_call(
        ...
        t3claw_turns::run_profile::AgentLoopHostError,
    > {
        self.validate_provider_tool_call(&tool_call)?;
        let input_ref =
            t3claw_turns::run_profile::CapabilityInputRef::new(format!("input:{}", tool_call.id))
                .unwrap();
    ...
    ) -> Result<VisibleCapabilitySurface, t3claw_turns::run_profile::AgentLoopHostError> {
    ...
    async fn invoke_capability(
        ...
        t3claw_turns::run_profile::CapabilityOutcome,
        t3claw_turns::run_profile::AgentLoopHostError,
    > {
    ...
    async fn invoke_capability_batch(
        ...
        t3claw_turns::run_profile::CapabilityBatchOutcome,
        t3claw_turns::run_profile::AgentLoopHostError,
    > {
