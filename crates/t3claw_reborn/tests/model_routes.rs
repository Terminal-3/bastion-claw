...
use t3claw_llm::{LlmConfig, NearAiConfig, SessionConfig};
...
fn model_slots_cover_builtin_interactive_and_mission_profiles() {
    let interactive_model =
        t3claw_turns::run_profile::ModelProfileId::new("interactive_model").unwrap();
    let mission_model = t3claw_turns::run_profile::ModelProfileId::new("mission_model").unwrap();
