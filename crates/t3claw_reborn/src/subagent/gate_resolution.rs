...
use t3claw_loop_support::{AwaitedChildSetRecord, SubagentGateResolutionStore, SubagentKindId};
use t3claw_turns::{
...
mod tests {
    ...
    use t3claw_loop_support::SpawnSubagentMode;
    use t3claw_turns::{LoopResultRef, ReplyTargetBindingRef, SourceBindingRef, TurnScope};
    ...
    fn record(gate_ref: &str, child_run_id: TurnRunId) -> AwaitedChildSetRecord {
        ...
        let mut parent_run_context =
            t3claw_agent_loop::test_support::test_run_context("subagent-gate");
    ...
    fn terminal_event(status: TurnStatus) -> AwaitedChildTerminalEvent {
        AwaitedChildTerminalEvent {
            ...
            owner_user_id: Some(t3claw_host_api::UserId::new("owner").unwrap()),
        }
    }
