...
pub(super) fn claimed_run() -> ClaimedTurnRun {
    let descriptor = t3claw_turns::AgentLoopDriverDescriptor {
...
fn test_profile(
    descriptor: t3claw_turns::AgentLoopDriverDescriptor,
    ...
    async fn apply_validated_loop_exit(
        ...
        *self.apply_calls.lock().expect("lock") += 1;
        match request.mapping {
            t3claw_turns::LoopExitMapping::RunnerOutcome(outcome) => match outcome {
                t3claw_turns::runner::TurnRunnerOutcome::Completed => {
                ...
                t3claw_turns::runner::TurnRunnerOutcome::Cancelled => {
                ...
                t3claw_turns::runner::TurnRunnerOutcome::Blocked {
                    checkpoint_id: _,
                    state_ref: _,
                    reason,
                } => {
                ...
                t3claw_turns::runner::TurnRunnerOutcome::Failed { failure } => {
            ...
            t3claw_turns::LoopExitMapping::RecoveryRequired { failure } => {
