...
- `crates/t3claw_safety/fuzz/README.md`
...
- Fast local check: `cargo test -p t3claw_safety`
- Fuzz-target check after parser/pattern changes: follow `crates/t3claw_safety/fuzz/README.md`
