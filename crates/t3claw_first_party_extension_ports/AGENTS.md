# Agent Map — t3claw_first_party_extension_ports

## Start Here

- Read `Cargo.toml` for actual dependencies and feature shape.
- Use these neighboring contracts before changing behavior:
  - `crates/t3claw_first_party_extensions/AGENTS.md`
  - `crates/t3claw_loop_support/AGENTS.md`
...
- Concrete tool behavior that can live below host runtime in `t3claw_first_party_extensions`.
...
- Fast local check: `cargo test -p t3claw_first_party_extension_ports`
- Boundary check after dependency/API changes: `cargo test -p t3claw_architecture reborn_crate_dependency_boundaries_hold`
- Composition check when exposed ports change: `cargo test -p t3claw_reborn_composition local_dev_runtime`
