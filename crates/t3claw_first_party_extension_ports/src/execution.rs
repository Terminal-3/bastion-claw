...
use t3claw_loop_support::{SkillBundleId, SkillBundleSource};
...
mod tests {
    ...
    async fn run_context() -> t3claw_turns::run_profile::LoopRunContext {
        let resolved = InMemoryRunProfileResolver::default()
            .resolve_run_profile(RunProfileResolutionRequest::interactive_default())
            .await
            .unwrap();
        t3claw_turns::run_profile::LoopRunContext::new(
            TurnScope::new(
