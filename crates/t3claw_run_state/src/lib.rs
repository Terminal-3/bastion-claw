//! Run-state contracts for T3Claw Reborn.
//!
//! `t3claw_run_state` stores the current lifecycle state for host-managed
...
//! [`ScopedFilesystem`](t3claw_filesystem::ScopedFilesystem). The
...
/// tenant/user-scoped [`VirtualPath`](t3claw_host_api::VirtualPath) per
/// its [`MountView`](t3claw_host_api::MountView) and enforces per-op ACL
...
/// returns post-resolution [`VirtualPath`](t3claw_host_api::VirtualPath)s,
...
/// (`crates/t3claw_run_state/CLAUDE.md`).
///
