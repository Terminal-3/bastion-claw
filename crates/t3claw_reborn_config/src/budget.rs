//! Resolved cost-based budget defaults for T3Claw Reborn.
//!
...
pub const USER_DAILY_USD_ENV: &str = "T3CLAW_BUDGET_USER_DAILY_USD";
/// Per-project daily ceiling in USD. `0` = unlimited.
pub const PROJECT_DAILY_USD_ENV: &str = "T3CLAW_BUDGET_PROJECT_DAILY_USD";
/// Per-tick budget for background missions. `0` = unlimited.
pub const MISSION_PER_TICK_USD_ENV: &str = "T3CLAW_BUDGET_MISSION_PER_TICK_USD";
/// Per-tick budget for heartbeat ticks. `0` = unlimited.
pub const HEARTBEAT_PER_TICK_USD_ENV: &str = "T3CLAW_BUDGET_HEARTBEAT_PER_TICK_USD";
/// Per-fire budget for lightweight routines. `0` = unlimited.
pub const ROUTINE_LIGHTWEIGHT_USD_ENV: &str = "T3CLAW_BUDGET_ROUTINE_LIGHTWEIGHT_USD";
/// Per-fire budget for standard routines. `0` = unlimited.
pub const ROUTINE_STANDARD_USD_ENV: &str = "T3CLAW_BUDGET_ROUTINE_STANDARD_USD";
/// Default per-job budget for one-shot container jobs. `0` = unlimited.
pub const BACKGROUND_JOB_DEFAULT_USD_ENV: &str = "T3CLAW_BUDGET_BACKGROUND_JOB_DEFAULT_USD";
/// IANA timezone for calendar-period rollover.
pub const BUDGET_DEFAULT_TZ_ENV: &str = "T3CLAW_BUDGET_DEFAULT_TZ";
/// Warn threshold fraction in `[0.0, 1.0]`.
pub const BUDGET_WARN_AT_ENV: &str = "T3CLAW_BUDGET_WARN_AT";
/// Pause-with-approval threshold fraction in `[0.0, 1.0]`.
pub const BUDGET_PAUSE_AT_ENV: &str = "T3CLAW_BUDGET_PAUSE_AT";
/// Pre-call estimate inflation multiplier.
pub const BUDGET_OVERESTIMATE_FACTOR_ENV: &str = "T3CLAW_BUDGET_OVERESTIMATE_FACTOR";
