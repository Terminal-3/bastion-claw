...
use t3claw_host_api::{CapabilityId, ExtensionId, InvocationId, RuntimeKind, ThreadId};
...
use t3claw_webui_v2::{WebChatV2Event, WebChatV2EventFrame};
        ...
        vec![
            ...
            ProductProjectionItem::RunStatus {
                ...
                failure_category: Some(
                    t3claw_turns::SanitizedFailure::new("driver_failed").unwrap(),
                ),
