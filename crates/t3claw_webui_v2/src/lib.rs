...
//! [`t3claw_product_workflow::RebornServicesApi`] facade. It is off by
...
//!
//! [`RebornServicesApi`]: t3claw_product_workflow::RebornServicesApi
//! [`WebChatV2EventFrame`]: crate::WebChatV2EventFrame
//! [`WebUiAuthenticatedCaller`]: t3claw_product_workflow::WebUiAuthenticatedCaller
//! [`IngressRouteDescriptor`]: t3claw_host_api::ingress::IngressRouteDescriptor
