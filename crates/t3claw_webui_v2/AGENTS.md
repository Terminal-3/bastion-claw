...
- Fast: `cargo test -p t3claw_webui_v2 --features webui-v2-beta`
- Lint: `cargo clippy -p t3claw_webui_v2 --all-features --tests -- -D warnings`
- Boundary: `cargo test -p t3claw_architecture reborn_crate_dependency_boundaries_hold`
