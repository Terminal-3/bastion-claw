use t3claw_extensions::{ExtensionManifestRecord, MANIFEST_SCHEMA_VERSION, ManifestSource};
use t3claw_host_api::HostPortCatalog;
use t3claw_product_adapter_registry::{
    ManifestHash, RegistryError, parse_product_adapter_manifest_record, product_adapter_sections,
};
use t3claw_product_adapters::{AuthRequirement, ProductCapabilityFlag, ProductSurfaceKind};
