# t3claw_wasm_sandbox_core guardrails

Owns shared v1-style WASM sandbox primitives for T3Claw runtimes.
...
- `t3claw_architecture` pins workspace independence and ProductAdapter usage.
