...
use t3claw_filesystem::{FileStat, FilesystemError, FilesystemOperation};
use t3claw_host_api::{RuntimeDispatchErrorKind, ScopedPath, VirtualPath};
use t3claw_safety::sensitive_paths::is_sensitive_path_str;
...
pub(super) fn operation_allowed(
    permissions: &t3claw_host_api::MountPermissions,
    operation: FilesystemOperation,
) -> bool {
    match operation {
