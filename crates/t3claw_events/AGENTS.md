...
- Production backend selection lives in `t3claw_reborn_event_store`, not here — downstream store crates depend on this substrate, never the reverse.
...
- Fast local check: `cargo test -p t3claw_events`
