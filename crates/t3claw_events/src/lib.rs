...
//! T3Claw Reborn.
//!
//! `t3claw_events` defines the small redacted vocabulary every
...
//!   in `t3claw_reborn_event_store`, which depends on these traits rather
//!   than pulling storage drivers back into `t3claw_events`.
//!
