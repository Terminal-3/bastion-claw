...
- Use the public executor entry point and real built-in families for behavior
  tests.
- Use `t3claw_agent_loop::test_support` for host fixtures and scripted model
...
- Do not duplicate `t3claw_reborn` driver-adapter coverage here.
