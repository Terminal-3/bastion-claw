...
use t3claw_turns::LoopFailureKind;
use t3claw_turns::{
    LoopExit,
    run_profile::{
...
pub(super) struct ApprovalResumePromptOutput {
    ...
    pub(super) pending_input_ack: PendingInputAck,
    pub(super) surface: VisibleCapabilitySurface,
    pub(super) call: t3claw_turns::run_profile::CapabilityCallCandidate,
}
...
enum CompactionCallOutcome {
    Completed(Result<LoopCompactionOutcome, t3claw_turns::run_profile::LoopCompactionError>),
    TimedOut,
    Cancelled,
}
