...
pub(super) fn capability_summary(
    ...
    let concurrency_hint = surface
        ...
        .unwrap_or(t3claw_turns::run_profile::ConcurrencyHint::Exclusive);
    CapabilityCallSummary {
...
pub(super) fn model_visible_capability_failure_observation(
    ...
    match &failure.detail {
        ...
        _ => ModelVisibleToolObservation {
            schema_version:
                t3claw_turns::run_profile::MODEL_VISIBLE_TOOL_OBSERVATION_SCHEMA_VERSION,
...
fn invalid_input_observation(issues: Vec<CapabilityInputIssue>) -> ModelVisibleToolObservation {
    ...
    ModelVisibleToolObservation {
        schema_version: t3claw_turns::run_profile::MODEL_VISIBLE_TOOL_OBSERVATION_SCHEMA_VERSION,
        status: ToolObservationStatus::Error,
...
mod tests {
    ...
    use t3claw_turns::run_profile::CapabilityProgress;
    ...
    fn push_completed_result_accumulates_bytes_per_capability() {
        ...
        let result_a1 = CapabilityResultMessage {
            result_ref: t3claw_turns::LoopResultRef::new("result:a1".to_string()).unwrap(),
        ...
        let result_a2 = CapabilityResultMessage {
            result_ref: t3claw_turns::LoopResultRef::new("result:a2".to_string()).unwrap(),
        ...
        let result_b = CapabilityResultMessage {
            result_ref: t3claw_turns::LoopResultRef::new("result:b".to_string()).unwrap(),
            safe_summary: "b".into(),
            progress: CapabilityProgress::MadeProgress,
            terminate_hint: false,
            byte_len: 2000,
