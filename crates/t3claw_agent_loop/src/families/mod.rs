...
const DEFAULT_FAMILY_FINGERPRINT: &[u8] = concat!(
    "t3claw_agent_loop.default_family.v1:",
    "family_id=default;",
...
pub const DEFAULT_FAMILY_DIGEST: ComponentDigest = ComponentDigest([
    0x6a, 0x29, 0xcf, 0xd7, 0xd7, 0xe7, 0x76, 0x4d, 0xa7, 0xa4, 0x99, 0xf3, 0x3d, 0xb9, 0xa2, 0xd7,
    0xd3, 0xbd, 0x49, 0xee, 0x38, 0xa8, 0xd4, 0xfe, 0x3e, 0x71, 0xae, 0x4b, 0xaf, 0x43, 0xd7, 0x37,
]);
