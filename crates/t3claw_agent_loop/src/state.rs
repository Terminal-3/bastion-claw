...
pub use t3claw_turns::LoopFailureKind;

use t3claw_host_api::{ApprovalRequestId, CapabilityId, CorrelationId, ResourceEstimate};
use t3claw_turns::{
...
mod tests {
    use serde_json::json;
    use t3claw_host_api::{CapabilityId, TenantId, ThreadId};
    use t3claw_turns::{
