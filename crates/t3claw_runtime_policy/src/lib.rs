//! Runtime profile resolver for T3Claw Reborn.
//!
...
//!
//! It depends only on the contract vocabulary in [`t3claw_host_api`] —
...
// re-exported here — callers consume them directly from `t3claw_host_api`.
pub use t3claw_host_api::runtime_policy::EffectiveRuntimePolicy;
