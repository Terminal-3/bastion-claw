# Agent Map — t3claw_reborn_composition
...
- Use these neighboring contracts before changing behavior:
  - `crates/t3claw_reborn/AGENTS.md`
  - `crates/t3claw_reborn_config/AGENTS.md`
...
- Root `t3claw` crate or `src/` module dependencies.
...
- Fast local check: `cargo test -p t3claw_reborn_composition`
