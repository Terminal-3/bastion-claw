...
use t3claw_reborn_composition::{RebornProviderAdmin, RebornProviderAdminProductCommandService};
use t3claw_reborn_config::{RebornBootConfig, RebornHome, RebornProfile};
...
impl ProductCommandAdmissionService for AllowingCommandAdmissionService {
    async fn admit(
        ...
        _command: &t3claw_product_workflow::ProductCommand,
