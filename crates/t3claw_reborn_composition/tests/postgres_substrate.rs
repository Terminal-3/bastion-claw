...
use t3claw_turns::{TurnRunWake, TurnRunWakeNotifier, TurnRunWakeNotifyError};
...
async fn postgres_substrate_builder_wires_production_components_without_local_only_seams() {
    ...
    let services =
        build_postgres_production_host_runtime_services(PostgresProductionSubstrateConfig {
            ...
            trust_policy: Arc::new(t3claw_trust::HostTrustPolicy::fail_closed()),
...
fn sandbox_process_port() -> Arc<t3claw_host_runtime::TenantSandboxProcessPort> {
    Arc::new(t3claw_host_runtime::TenantSandboxProcessPort::new(
