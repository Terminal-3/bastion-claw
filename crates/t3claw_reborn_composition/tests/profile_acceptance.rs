...
use serde_json::json;
use t3claw_host_api::runtime_policy::{FilesystemBackendKind, RuntimeProfile, SecretMode};
use t3claw_host_runtime::{
    ProductionWiringComponent, ProductionWiringIssue, ProductionWiringIssueKind,
    ProductionWiringReport,
};
use t3claw_runtime_policy::ResolveError;
...
fn readiness_diagnostics_do_not_carry_sensitive_detail_fields() {
    ...
    assert!(!json.contains("t3claw_host_runtime::"));
