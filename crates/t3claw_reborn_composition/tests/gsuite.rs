...
use t3claw_extensions::{ExtensionRuntime, ManifestSource};
...
use t3claw_host_runtime::FirstPartyCapabilityRequest;
...
fn asset_manifest(extension_id: &str) -> t3claw_extensions::ExtensionManifest {
    let manifest_toml = match extension_id {
        "google-calendar" => {
            include_str!("../../t3claw_first_party_extensions/assets/google-calendar/manifest.toml")
        }
        "gmail" => include_str!("../../t3claw_first_party_extensions/assets/gmail/manifest.toml"),
        other => panic!("unknown GSuite asset manifest {other}"),
    };
    t3claw_extensions::ExtensionManifest::parse(
        manifest_toml,
        ManifestSource::HostBundled,
        &t3claw_host_api::HostPortCatalog::empty(),
    )
    .unwrap()
}
            ...
            .map(|capability| {
                ...
                (
                    ...
                    vec![(
                        ...
                        t3claw_auth::GOOGLE_PROVIDER_ID.to_string(),
...
async fn bundled_gsuite_handler_projects_stage_auth_required_to_first_party_auth_required() {
    ...
    assert_eq!(
        ...
        t3claw_auth::GOOGLE_PROVIDER_ID
    );
