...
use t3claw_auth::{AuthProductError, CredentialAccountLabel, OAuthClientId, OAuthRedirectUri};
#[cfg(any(feature = "libsql", feature = "postgres"))]
use t3claw_host_api::runtime_policy::ProcessBackendKind;
#[cfg(feature = "postgres")]
use t3claw_host_api::runtime_policy::{DeploymentMode, RuntimeProfile};
...
use t3claw_host_runtime::HostRuntimeHttpEgressPort;
use t3claw_host_runtime::TenantSandboxProcessPort;
use t3claw_trust::HostTrustPolicy;
use t3claw_turns::TurnRunWakeNotifier;

#[cfg(feature = "postgres")]
use t3claw_reborn_config::StorageBackend;
...
#[cfg(feature = "postgres")]
const DEFAULT_REBORN_POSTGRES_URL_ENV: &str = "T3CLAW_REBORN_POSTGRES_URL";
#[cfg(feature = "postgres")]
const DEFAULT_REBORN_SECRET_MASTER_KEY_ENV: &str = "T3CLAW_REBORN_SECRET_MASTER_KEY";
...
pub struct RebornBuildInput {
    ...
    pub(crate) required_runtime_backends: Vec<t3claw_host_api::RuntimeKind>,
...
impl RebornBuildInput {
    ...
    pub fn postgres_from_config_and_env(
        ...
        let pool_max_size = storage
            .pool_max_size
            .unwrap_or(t3claw_reborn_event_store::DEFAULT_POSTGRES_POOL_MAX_SIZE);
        let pool =
    ...
    pub fn with_required_runtime_backends(
        mut self,
        backends: impl IntoIterator<Item = t3claw_host_api::RuntimeKind>,
    ) -> Self {
    ...
    /// composed the profile's [`t3claw_turns::TurnCoordinator`], so OAuth
    ...
    ) -> Result<Self, t3claw_auth::AuthProductError> {
...
mod tests {
    ...
    use t3claw_auth::InMemoryAuthProductServices;
