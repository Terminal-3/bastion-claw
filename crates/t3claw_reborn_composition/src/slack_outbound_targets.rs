...
use t3claw_product_adapters::{AdapterInstallationId, ExternalActorRef, ExternalConversationRef};
#[cfg(test)]
use t3claw_product_adapters::{EgressCredentialHandle, ProtocolHttpEgress};
...
use t3claw_slack_v2_adapter::{SLACK_USER_ACTOR_KIND, SLACK_V2_ADAPTER_ID};
use t3claw_turns::ReplyTargetBindingRef;
use thiserror::Error;
