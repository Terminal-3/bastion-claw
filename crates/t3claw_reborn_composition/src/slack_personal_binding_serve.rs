...
mod tests {
    ...
    fn tenant(value: &str) -> t3claw_host_api::TenantId {
        t3claw_host_api::TenantId::new(value).expect("tenant")
    }

    fn user(value: &str) -> t3claw_host_api::UserId {
        t3claw_host_api::UserId::new(value).expect("user")
    }
