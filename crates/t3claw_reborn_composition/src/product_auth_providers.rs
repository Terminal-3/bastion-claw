...
use t3claw_host_api::RuntimeHttpEgress;
use t3claw_host_runtime::ProductAuthProviderRuntimePorts;
...
mod tests {
    ...
    use t3claw_capabilities::{CapabilityObligationError, CapabilityObligationRequest};
    use t3claw_host_api::{
