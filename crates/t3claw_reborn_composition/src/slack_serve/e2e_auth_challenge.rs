...
use t3claw_auth::{AuthProductError, AuthProviderId, OAuthAuthorizationUrl};
use t3claw_host_api::{AgentId, ProjectId, UserId};
...
type AuthChallengeCall = (
    ...
    TurnRunId,
    String,
    Vec<t3claw_host_api::RuntimeCredentialAuthRequirement>,
);
