...
use t3claw_host_api::{AgentId, ProjectId, ResourceScope, TenantId, UserId};
use t3claw_outbound::{FilesystemOutboundStateStore, OutboundStateStore};
...
use t3claw_product_workflow_storage::RebornFilesystemIdempotencyLedger;
use t3claw_slack_v2_adapter::{
...
use t3claw_wasm_product_adapters::{
...
fn build_slack_events_route_mount_with_resolvers(
    ...
    let preferences: Arc<dyn t3claw_outbound::CommunicationPreferenceRepository> = outbound;
...
mod tests {
    ...
    use t3claw_processes::{InMemoryProcessResultStore, InMemoryProcessStore, ProcessServices};
    use t3claw_product_workflow::{
    ...
    use t3claw_threads::{ListThreadsForScopeRequest, ThreadHistoryRequest, ThreadScope};
    use t3claw_turns::{
