...
use t3claw_event_projections::{CapabilityActivityProjection, CapabilityActivityStatus};
use t3claw_host_api::{
...
use t3claw_threads::ThreadMessageId;
use t3claw_turns::{TurnRunId, run_profile::CapabilityInputRef};
