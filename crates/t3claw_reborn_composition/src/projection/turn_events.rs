...
use t3claw_reborn::failure_categories::MODEL_CREDITS_EXHAUSTED_CATEGORY;
...
impl TurnEventBridge {
    ...
    pub(super) async fn drain(
        &self,
        caller_user_id: &t3claw_host_api::UserId,
        scope: &TurnScope,
...
fn failure_explanation_system_prompt() -> &'static str {
    t3claw_loop_support::FAILURE_EXPLANATION_SYSTEM_PROMPT
}
