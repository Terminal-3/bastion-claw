...
use t3claw_loop_support::{BudgetSeedingPolicy, GovernorBackedAccountant, ModelCostTable};
...
use t3claw_turns::run_profile::LoopModelBudgetAccountant;
...
mod tests {
    ...
    use t3claw_host_api::{InvocationId, ResourceEstimate, ResourceScope, TenantId, UserId};
    use t3claw_loop_support::ZeroCostTable;
    use t3claw_resources::{
    ...
    async fn seeds_compiled_default_user_cap_on_first_touch() {
        ...
        let request = t3claw_turns::run_profile::LoopModelRequest {
            messages: vec![],
    ...
    fn test_run_context(tenant: &str, user: &str) -> t3claw_turns::run_profile::LoopRunContext {
