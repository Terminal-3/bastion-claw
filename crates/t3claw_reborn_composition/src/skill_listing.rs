...
use t3claw_skills::{ManagedSkillSource, SkillManagementError, SkillManagementErrorKind};
...
) -> Result<Vec<t3claw_skills::SkillSummary>, RebornSkillListError> {
    let mut skills =
...
mod tests {
    use super::*;
    use t3claw_skills::ManagedSkillSource;
