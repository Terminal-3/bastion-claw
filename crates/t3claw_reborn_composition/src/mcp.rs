...
#[cfg(test)]
mod tests {
    use t3claw_extensions::{ExtensionManifest, ExtensionPackage, ManifestSource};
    use t3claw_host_api::{
    ...
    fn registry_with_notion() -> t3claw_extensions::ExtensionRegistry {
    ...
    ) -> t3claw_extensions::ExtensionRegistry {
        ...
        registry
            .insert(
                ExtensionPackage::from_manifest(
                    ExtensionManifest {
                        schema_version: t3claw_extensions::MANIFEST_SCHEMA_VERSION.to_string(),
                        id: ExtensionId::new(provider).unwrap(),
                        name: provider.to_string(),
                        version: "0.1.0".to_string(),
                        description: "Hosted MCP".to_string(),
                        source: ManifestSource::HostBundled,
                        requested_trust: t3claw_host_api::RequestedTrustClass::ThirdParty,
                        descriptor_trust_default: TrustClass::Sandbox,
                        runtime: t3claw_extensions::ExtensionRuntime::Mcp {
                        ...
                        host_apis: Vec::new(),
                        hooks: Vec::new(),
                        capabilities: vec![t3claw_extensions::CapabilityManifest {
                            id: CapabilityId::new(capability_id).unwrap(),
                            implements: Vec::new(),
                            description: "Search".to_string(),
                            effects: vec![
                                t3claw_host_api::EffectKind::DispatchCapability,
                                t3claw_host_api::EffectKind::Network,
                                t3claw_host_api::EffectKind::UseSecret,
                            ],
                            default_permission: PermissionMode::Allow,
                            visibility: t3claw_extensions::CapabilityVisibility::Model,
                            ...
                            runtime_credentials: vec![
                                t3claw_host_api::RuntimeCredentialRequirement {
