...
impl RebornLocalSkillManagementPort {
    ...
    pub(crate) async fn list_for_scope(
        &self,
        scope: ResourceScope,
    ) -> Result<Vec<t3claw_skills::SkillSummary>, RebornLocalSkillManagementError> {
    ...
    pub(crate) async fn search_for_scope(
        ...
        query: &str,
        limit: usize,
    ) -> Result<t3claw_skills::SkillSearchResult, RebornLocalSkillManagementError> {
        let context = self.skill_context_for_scope(scope)?;
    ...
    pub(crate) async fn read_content_for_scope(
        ...
        scope: ResourceScope,
        name: &str,
    ) -> Result<t3claw_skills::SkillContentResult, RebornLocalSkillManagementError> {
        let context = self.skill_context_for_scope(scope)?;
        Ok(read_skill_content(&context, t3claw_skills::SkillContentRequest { name }).await?)
    }
    ...
    pub(crate) async fn update_for_scope(
        ...
        name: &str,
        content: &str,
    ) -> Result<t3claw_skills::SkillUpdateResult, RebornLocalSkillManagementError> {
        let context = self.skill_context_for_scope(scope)?;
    ...
    pub(crate) async fn install_for_scope(
        ...
        name: Option<&str>,
        content: &str,
    ) -> Result<t3claw_skills::SkillInstallResult, RebornLocalSkillManagementError> {
        let context = self.skill_context_for_scope(scope)?;
        Ok(install_skill(
            &context,
            SkillInstallRequest {
    ...
    pub(crate) async fn remove_for_scope(
        ...
        scope: ResourceScope,
        name: &str,
    ) -> Result<t3claw_skills::SkillRemoveResult, RebornLocalSkillManagementError> {
        let context = self.skill_context_for_scope(scope)?;
...
fn skill_summary(
    skill: t3claw_skills::SkillSummary,
    ...
    Ok(LifecycleSkillSummary {
        ...
        source: match skill.source {
            t3claw_skills::ManagedSkillSource::System => LifecycleSkillSource::System,
            t3claw_skills::ManagedSkillSource::User
            | t3claw_skills::ManagedSkillSource::Installed => LifecycleSkillSource::User,
        },
...
mod tests {
    ...
    use t3claw_product_workflow::LifecycleProductSurfaceContext;
