...
use t3claw_host_api::{EffectKind, PackageSource};
use t3claw_product_workflow::ProductWorkflowError;
use t3claw_trust::{AdminEntry, HostTrustAssignment, HostTrustPolicy, InvalidationBus, TrustError};
...
) -> Result<t3claw_trust::TrustPolicyInput, ProductWorkflowError> {
    package
        .trust_policy_input(
