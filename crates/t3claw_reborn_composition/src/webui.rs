...
use t3claw_host_api::{InvocationId, ResourceScope};
...
fn skill_list_response(skills: Vec<t3claw_skills::SkillSummary>) -> RebornSkillListResponse {
...
fn skill_info(skill: t3claw_skills::SkillSummary) -> RebornSkillInfo {
    let source_kind = match skill.source {
        t3claw_skills::ManagedSkillSource::System => RebornSkillSourceKind::System,
        t3claw_skills::ManagedSkillSource::User => RebornSkillSourceKind::User,
        t3claw_skills::ManagedSkillSource::Installed => RebornSkillSourceKind::Installed,
    };
...
fn map_skill_management_error(error: RebornLocalSkillManagementError) -> RebornServicesError {
    match error {
        ...
        RebornLocalSkillManagementError::Skill(error) => match error.kind() {
            t3claw_skills::SkillManagementErrorKind::NotFound => RebornServicesError {
            ...
            t3claw_skills::SkillManagementErrorKind::Conflict => RebornServicesError {
            ...
            t3claw_skills::SkillManagementErrorKind::Resource => RebornServicesError {
            ...
            t3claw_skills::SkillManagementErrorKind::FilesystemDenied => RebornServicesError {
            ...
            t3claw_skills::SkillManagementErrorKind::InvalidInput
            | t3claw_skills::SkillManagementErrorKind::InvalidSkill => invalid_skill_request(),
        },
    }
}
...
mod tests {
    use super::*;
    use std::path::Path;
    use t3claw_filesystem::LocalFilesystem;
    use t3claw_host_api::{
    ...
    async fn skills_product_facade_hides_owner_user_skills_from_other_callers() {
        ...
        let filesystem: Arc<dyn t3claw_filesystem::RootFilesystem> = Arc::new(filesystem);
