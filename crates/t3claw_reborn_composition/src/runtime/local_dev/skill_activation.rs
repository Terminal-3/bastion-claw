...
use t3claw_loop_support::CapabilityResultWrite;
...
fn skill_activation_host_error(
    error: t3claw_first_party_extension_ports::SkillActivationSelectionError,
) -> AgentLoopHostError {
    let kind = match error {
        t3claw_first_party_extension_ports::SkillActivationSelectionError::AmbiguousSkill {
            ..
        }
        | t3claw_first_party_extension_ports::SkillActivationSelectionError::ParseFailed
        | t3claw_first_party_extension_ports::SkillActivationSelectionError::TrustDataMissing
        | t3claw_first_party_extension_ports::SkillActivationSelectionError::VisibilityDataMissing => {
            AgentLoopHostErrorKind::InvalidInvocation
        }
        t3claw_first_party_extension_ports::SkillActivationSelectionError::ContextBudgetExceeded => {
            AgentLoopHostErrorKind::BudgetExceeded
        }
        t3claw_first_party_extension_ports::SkillActivationSelectionError::SourceUnavailable => {
            AgentLoopHostErrorKind::Unavailable
        }
        t3claw_first_party_extension_ports::SkillActivationSelectionError::Internal => {
