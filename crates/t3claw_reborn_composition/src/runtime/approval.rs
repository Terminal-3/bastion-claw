...
use t3claw_host_api::{EffectKind, MountView, Principal};
...
impl ApprovalLeaseTermsProvider for LocalDevApprovalLeaseTermsProvider {
    async fn lease_terms_for(
        &self,
        gate: &ApprovalGateRecord,
    ) -> Result<t3claw_approvals::LeaseApproval, ProductWorkflowError> {
...
mod tests {
    ...
    use t3claw_product_workflow::approval_gate_ref;
    use t3claw_turns::{GateRef, TurnRunId};
        ...
        let source = LocalDevExtensionSurfaceSource::from_surface(
            LocalDevExtensionSurface::from_active_capabilities(vec![ActiveExtensionCapability {
                ...
                runtime_credentials: vec![t3claw_host_api::RuntimeCredentialRequirement {
                    ...
                    audience: t3claw_host_api::NetworkTargetPattern {
