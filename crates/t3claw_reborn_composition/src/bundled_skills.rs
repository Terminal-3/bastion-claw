...
use t3claw_host_api::{HostPath, VirtualPath};
use t3claw_loop_support::SkillFilePath;
use t3claw_skills::{ManagedSkillSource, SkillSummary};
...
const BUNDLED_MARKER_FILE: &str = ".t3claw-reborn-bundled.json";
const BUNDLED_INSTALL_LOCK_FILE: &str = ".t3claw-reborn-bundled.lock";
const BUNDLED_MARKER_OWNER: &str = "t3claw_reborn_composition_bundled_skill";
