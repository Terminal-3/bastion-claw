...
use t3claw_host_api::{ResourceScope, ScopedPath, SecretHandle};
...
fn product_auth_root(scope: &t3claw_auth::AuthProductScope) -> String {
...
fn surface_path_segment(surface: AuthSurface) -> &'static str {
    match surface {
        t3claw_auth::AuthSurface::Chat => "chat",
        t3claw_auth::AuthSurface::Web => "web",
        t3claw_auth::AuthSurface::Cli => "cli",
        t3claw_auth::AuthSurface::Tui => "tui",
        t3claw_auth::AuthSurface::Api => "api",
        t3claw_auth::AuthSurface::SetupAdmin => "setup-admin",
        t3claw_auth::AuthSurface::Callback => "callback",
    }
}
