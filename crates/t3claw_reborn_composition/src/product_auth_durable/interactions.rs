...
use t3claw_filesystem::{CasExpectation, FilesystemError, RecordVersion, RootFilesystem};
    ...
    F: RootFilesystem + 'static,
{
    ...
    async fn find_reusable_manual_token_account(
        ...
        let owner = t3claw_auth::CredentialAccountOwnerScope::from_scope(&pending.scope);
    ...
    async fn cleanup_manual_secret(
        ...
        access_secret: &Option<t3claw_host_api::SecretHandle>,
    ) {
...
fn validate_reusable_manual_token_account(
    ...
    if account.provider != pending.provider
        ...
        || account.status == t3claw_auth::CredentialAccountStatus::Revoked
    {
...
struct StoredManualTokenInteraction {
    ...
    label: t3claw_auth::CredentialAccountLabel,
    continuation: t3claw_auth::AuthContinuationRef,
