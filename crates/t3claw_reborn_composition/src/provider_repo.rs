...
//! through `t3claw_llm::ProviderRegistry`. This module owns the *write*
...
//! `.lock` sidecar discipline `t3claw_reborn_config` uses for `config.toml`,
...
use t3claw_llm::registry::ProviderDefinition;
use thiserror::Error;
