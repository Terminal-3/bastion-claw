...
use t3claw_reborn_config::{RebornBootConfig, RebornConfigFile};
...
/// running provider's inner backend via the `t3claw_llm` reload handle.
pub(crate) struct RebornLlmReloadAdapter {
    boot: RebornBootConfig,
    reload_handle: Arc<t3claw_llm::LlmReloadHandle>,
