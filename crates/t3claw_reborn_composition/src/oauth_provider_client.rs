...
) -> Result<t3claw_host_api::ExecutionContext, AuthProductError> {
    let context = t3claw_host_api::ExecutionContext {
        ...
        extension_id: ExtensionId::new("t3claw_auth")
            .map_err(|_| AuthProductError::BackendUnavailable)?,
        runtime: RuntimeKind::System,
...
fn map_secret_store_error(error: t3claw_secrets::SecretStoreError) -> AuthProductError {
    tracing::debug!(
...
fn map_refresh_secret_error(error: t3claw_secrets::SecretStoreError) -> AuthProductError {
