...
use t3claw_product_adapters::ProtocolAuthEvidence;
...
fn ingress_error_response(error: SlackIngressError) -> Response {
    match error {
        ...
        SlackIngressError::Envelope(error) => {
            tracing::debug!(
                target = "t3claw::reborn::slack_events",
                error = %error,
...
mod tests {
    ...
    use t3claw_product_adapters::capabilities::ProductAdapterCapabilities;
    use t3claw_product_adapters::external::{
        ExternalActorRef, ExternalConversationRef, ExternalEventId,
    };
    use t3claw_product_adapters::identity::{
    ...
    use t3claw_slack_v2_adapter::SlackPayloadParseError;
    use t3claw_wasm_product_adapters::{
    ...
    #[async_trait]
    impl t3claw_product_adapters::ProductWorkflow for AckWorkflow {
        ...
        async fn resolve_projection_subscription(
            ...
            Err(ProductAdapterError::Internal {
                detail: t3claw_product_adapters::redaction::RedactedString::new(
