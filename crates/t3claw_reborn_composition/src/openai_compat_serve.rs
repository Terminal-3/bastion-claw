...
use t3claw_reborn_openai_compat_storage::FilesystemOpenAiCompatRefStore;
use t3claw_threads::{
    ...
    async fn read_chat_completion_projection(
        ...
        loop {
                ...
                .await
            {
                ...
                Err(error) => {
                    tracing::warn!(
                        target = "t3claw::reborn::openai_compat",
                        error = %error,
...
fn response_object(
    id: t3claw_reborn_openai_compat::OpenAiResponseId,
    created_at: u64,
    model: String,
...
fn invalid_openai_compat_config(
    field: &'static str,
) -> impl FnOnce(t3claw_product_adapters::ProductAdapterError) -> RebornBuildError {
