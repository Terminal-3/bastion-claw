...
use t3claw_runtime_policy::{EffectiveRuntimePolicy as ResolvedRuntimePolicy, ResolveError};
use thiserror::Error;
...
fn local_runtime_policy(
    ...
    let request = t3claw_runtime_policy::ResolveRequest {
        yolo_disclosure_acknowledged: options.confirm_host_access,
        ..t3claw_runtime_policy::ResolveRequest::new(
            DeploymentMode::LocalSingleUser,
            runtime_profile,
        )
    };
    Ok(t3claw_runtime_policy::resolve(request)?)
}
