# Agent Map — t3claw_conversations
...
- Use these neighboring contracts before changing behavior:
  ...
  - `crates/t3claw_threads/CLAUDE.md`
...
- Fast local check: `cargo test -p t3claw_conversations`
...
- Preserve typed `t3claw_turns::TurnError`; do not flatten turn failures to strings.
