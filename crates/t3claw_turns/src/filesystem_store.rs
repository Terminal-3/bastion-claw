...
use t3claw_host_api::{ResourceScope, ScopedPath, UserId};
...
/// [`MountView`](t3claw_host_api::MountView) and enforces per-op ACL before
...
// `t3claw_run_state::FilesystemRunStateStore`; only one snapshot path lives
