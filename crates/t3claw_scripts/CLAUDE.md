...
- Keep script-specific execution semantics here. Extension parsing belongs in `t3claw_extensions`, dispatch selection in `t3claw_dispatcher`, process lifecycle in `t3claw_processes`, and product workflow outside this crate.
