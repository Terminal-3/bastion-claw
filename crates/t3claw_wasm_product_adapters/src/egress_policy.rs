...
//! [`t3claw_product_adapters::ProtocolHttpEgress`] for a v2 adapter, it
...
use t3claw_product_adapters::{DeclaredEgressHost, DeclaredEgressTarget, EgressCredentialHandle};
use thiserror::Error;
