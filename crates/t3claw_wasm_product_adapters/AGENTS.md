# Agent Map — t3claw_wasm_product_adapters
...
- Use these neighboring contracts before changing behavior:
  - `crates/t3claw_product_adapters/AGENTS.md`
  - `crates/t3claw_wasm_sandbox_core/CLAUDE.md`
...
- Shared product-surface DTOs; keep those in `t3claw_product_adapters`.
...
- Fast local check: `cargo test -p t3claw_wasm_product_adapters`
- Focused check: `cargo test -p t3claw_wasm_product_adapters --test component_runtime_contract`
