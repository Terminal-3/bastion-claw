...
impl FirstPartyCapabilityRequest {
    ...
    pub fn request_for_test(
        ...
        scope: ResourceScope,
        input: Value,
        runtime_http_egress: Option<Arc<dyn t3claw_host_api::RuntimeHttpEgress>>,
    ) -> Self {
        Self {
            capability_id,
            scope,
            ...
            services: InvocationServices {
                filesystem: Arc::new(t3claw_filesystem::InMemoryBackend::new()),
                runtime_http_egress,
...
mod tests {
    use super::*;
    use t3claw_host_api::{ResourceUsage, SecretHandle};
