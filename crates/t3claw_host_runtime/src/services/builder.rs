...
use t3claw_secrets::{CredentialAccountStore, CredentialSessionStore};
    ...
    R: ProcessResultStore + 'static,
{
    ...
    /// [`RootFilesystem`](t3claw_filesystem::RootFilesystem); see
    ...
    /// `t3claw_capabilities::host`. Production composition should layer a
    ...
    /// `t3claw_reborn_event_store`, then this method adapts the durable logs
