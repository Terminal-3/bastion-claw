...
impl ResourceGovernor for ReconcileFailingGovernor {
    fn set_limit(
        ...
        limits: t3claw_resources::ResourceLimits,
    ) -> Result<(), t3claw_resources::ResourceError> {
    ...
    fn reserve_with_outcome(
        ...
        estimate: t3claw_host_api::ResourceEstimate,
    ) -> Result<t3claw_resources::ReservationOutcome, t3claw_resources::ResourceError> {
    ...
    fn reserve_with_id_and_outcome(
        ...
        scope: t3claw_host_api::ResourceScope,
        estimate: t3claw_host_api::ResourceEstimate,
        reservation_id: t3claw_host_api::ResourceReservationId,
    ) -> Result<t3claw_resources::ReservationOutcome, t3claw_resources::ResourceError> {
        self.inner
    ...
    fn reconcile(
        &self,
        reservation_id: t3claw_host_api::ResourceReservationId,
        _actual: t3claw_host_api::ResourceUsage,
    ) -> Result<t3claw_host_api::ResourceReceipt, t3claw_resources::ResourceError> {
        Err(t3claw_resources::ResourceError::UnknownReservation { id: reservation_id })
    }
    ...
    fn account_snapshot(
        &self,
        account: &ResourceAccount,
    ) -> Result<Option<t3claw_resources::AccountSnapshot>, t3claw_resources::ResourceError> {
