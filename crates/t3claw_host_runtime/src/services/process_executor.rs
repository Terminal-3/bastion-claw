...
use t3claw_host_api::{CapabilityDispatchRequest, CapabilityDispatcher, RuntimeKind};
...
fn is_process_sandbox_request(request: &ProcessExecutionRequest) -> bool {
    request.runtime == RuntimeKind::System
        && request.capability_id.as_str() == t3claw_process_sandbox::PROCESS_SANDBOX_CAPABILITY_ID
}
...
mod tests {
    ...
    use t3claw_processes::ProcessCancellationToken;
