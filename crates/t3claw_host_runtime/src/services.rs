...
use t3claw_approvals::ApprovalResolver;
...
use t3claw_extensions::{ExtensionRegistry, ExtensionRuntime, SharedExtensionRegistry};
#[cfg(feature = "libsql")]
...
use t3claw_mcp::{McpError, McpExecutionRequest, McpExecutor, McpInvocation};
use t3claw_network::NetworkHttpEgress;
...
use t3claw_scripts::{ScriptError, ScriptExecutionRequest, ScriptExecutor, ScriptInvocation};
use t3claw_secrets::{
    CredentialAccountStore, CredentialSessionStore, InMemoryCredentialBroker, InMemorySecretStore,
    SecretStore, SecretStoreError,
};
use t3claw_trust::{HostTrustPolicy, TrustPolicy};
use t3claw_turns::{
...
/// [`t3claw_host_api::CredentialStageError`].
    ...
    R: ProcessResultStore + 'static,
{
    ...
    fn build_host_runtime(&self) -> DefaultHostRuntime {
        ...
        let process_manager: Arc<dyn ProcessManager> = Arc::new(
            t3claw_processes::BackgroundProcessManager::new(
