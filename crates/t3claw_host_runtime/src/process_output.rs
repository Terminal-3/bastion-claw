...
const COMMAND_OUTPUT_TEMP_PREFIX: &str = "t3claw-command-output-";
const COMMAND_OUTPUT_SCRATCH_PREFIX: &str = "t3claw-command-output-scratch-";
...
const COMMAND_OUTPUT_ROOT_DIRNAME: &str = "t3claw-command-outputs";
...
/// scope's saved-output files. The path layout — `<tempdir>/t3claw-command-
...
mod tests {
    use super::*;
    use t3claw_host_api::{InvocationId, ResourceScope, UserId};
