...
const REBORN_NETWORK_MODE_ENV: &str = "T3CLAW_REBORN_NETWORK_MODE";
const REBORN_HTTP_PROXY_ENV: &str = "T3CLAW_REBORN_HTTP_PROXY";
const REBORN_HTTP_BROKER_SOCKET_ENV: &str = "T3CLAW_REBORN_HTTP_BROKER_SOCKET";
const REBORN_HTTP_BROKER_URL_ENV: &str = "T3CLAW_REBORN_HTTP_BROKER_URL";
const REBORN_SECRET_MODE_ENV: &str = "T3CLAW_REBORN_SECRET_MODE";
const REBORN_SECRET_BROKER_ENV: &str = "T3CLAW_REBORN_SECRET_BROKER_URL";
const REBORN_SECRET_BROKER_SOCKET_ENV: &str = "T3CLAW_REBORN_SECRET_BROKER_SOCKET";
...
const CONTAINER_HTTP_BROKER_SOCKET: &str = "/tmp/t3claw-http-broker.sock";
const CONTAINER_SECRET_BROKER_SOCKET: &str = "/tmp/t3claw-secret-broker.sock";
const CONTAINER_BROKER_URL: &str = "http://t3claw-broker";
