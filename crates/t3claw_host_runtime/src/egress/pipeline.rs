...
use t3claw_network::{NetworkHttpEgress, NetworkHttpRequest};
...
) -> Result<t3claw_network::NetworkHttpResponse, PipelineError>
where
    N: NetworkHttpEgress + Send + Sync,
{
    service
    ...
    N: NetworkHttpEgress + Send + Sync,
{
        ...
        .await
    {
        ...
        Err(t3claw_network::NetworkHttpError::ResponseBodyLimit {
