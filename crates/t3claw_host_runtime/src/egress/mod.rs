...
use t3claw_network::{NetworkHttpEgress, NetworkHttpError};
...
pub(super) fn runtime_response(
    response: t3claw_network::NetworkHttpResponse,
    redaction_applied: bool,
    saved_body: Option<t3claw_host_api::RuntimeHttpSavedBody>,
