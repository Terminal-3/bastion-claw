...
use t3claw_events::InMemoryAuditSink;
use t3claw_extensions::ExtensionRegistry;
#[cfg(feature = "libsql")]
use t3claw_filesystem::LibSqlRootFilesystem;
use t3claw_filesystem::{InMemoryBackend, LocalFilesystem, RootFilesystem};
use t3claw_host_api::runtime_policy::{
...
use t3claw_resources::{InMemoryResourceGovernor, ResourceAccount};
use t3claw_secrets::InMemorySecretStore;
use t3claw_triggers::{
...
async fn builtin_shell_maps_timeout_and_spawn_failures() {
    ...
    let spawn = invoke_shell(json!({
            ...
            "workdir": "/definitely/missing/t3claw-shell-test"
    }))
    .await
    .unwrap_err();
...
async fn builtin_shell_does_not_inherit_unlisted_parent_env() {
    ...
    unsafe {
        std::env::set_var("T3CLAW_SHELL_SECRET_TEST", "must_not_leak");
    }
    let output = invoke_shell(json!({
        "command": "printf ${T3CLAW_SHELL_SECRET_TEST:-missing}"
    }))
    .await;
    // SAFETY: clears only the test-owned key set above.
    unsafe {
        std::env::remove_var("T3CLAW_SHELL_SECRET_TEST");
    }
...
async fn builtin_skill_install_url_path_rejects_invalid_zip_bundles() {
    ...
    let too_many_entries = (0..(t3claw_skills::MAX_INSTALL_BUNDLE_FILES * 4 + 1))
        .map(|index| (format!("bundle/empty-{index}.txt"), Vec::new()))
        .collect::<Vec<_>>();
    let too_many_directories = (0..(t3claw_skills::MAX_INSTALL_BUNDLE_FILES * 4 + 1))
...
fn trigger_backend_error() -> t3claw_triggers::TriggerError {
    t3claw_triggers::TriggerError::Backend {
...
impl TriggerRepository for RemoveFailingTriggerRepository {
    async fn upsert_trigger(
        &self,
        record: t3claw_triggers::TriggerRecord,
    ) -> Result<(), t3claw_triggers::TriggerError> {
    ...
    async fn get_trigger(
        &self,
        tenant_id: TenantId,
        trigger_id: t3claw_triggers::TriggerId,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn list_triggers(
        &self,
        tenant_id: TenantId,
    ) -> Result<Vec<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn remove_trigger(
        &self,
        _tenant_id: TenantId,
        _trigger_id: t3claw_triggers::TriggerId,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn list_active_triggers_after(
        &self,
        after: Option<t3claw_triggers::ActiveTriggerScanCursor>,
        limit: usize,
    ) -> Result<Vec<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn claim_due_fire(
        &self,
        request: t3claw_triggers::ClaimDueFireRequest,
    ) -> Result<t3claw_triggers::ClaimDueFireOutcome, t3claw_triggers::TriggerError> {
        self.inner.claim_due_fire(request).await
    }

    async fn mark_fire_accepted(
        &self,
        request: t3claw_triggers::FireAcceptedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn mark_fire_replayed(
        &self,
        request: t3claw_triggers::FireReplayedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn mark_fire_retryable_failed(
        &self,
        request: t3claw_triggers::FireRetryableFailedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn mark_fire_permanently_failed(
        &self,
        request: t3claw_triggers::FirePermanentFailedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn mark_fire_terminally_failed(
        &self,
        request: t3claw_triggers::FireTerminalFailedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn clear_active_fire(
        &self,
        request: t3claw_triggers::ClearActiveFireRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
...
impl TriggerRepository for BatchRunHistoryFailingTriggerRepository {
    ...
    async fn list_trigger_run_history_batch(
        &self,
        _tenant_id: TenantId,
        _trigger_ids: &[t3claw_triggers::TriggerId],
        _limit: usize,
    ) -> Result<HashMap<t3claw_triggers::TriggerId, Vec<TriggerRunRecord>>, TriggerError> {
        Err(trigger_backend_error())
    }
}
...
impl TriggerRepository for FailingTriggerRepository {
    async fn upsert_trigger(
        &self,
        _record: t3claw_triggers::TriggerRecord,
    ) -> Result<(), t3claw_triggers::TriggerError> {
        Err(trigger_backend_error())
    }
    ...
    async fn list_active_triggers_after(
        &self,
        _after: Option<t3claw_triggers::ActiveTriggerScanCursor>,
        _limit: usize,
    ) -> Result<Vec<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
        unreachable!("failing test repository does not list active triggers")
    }
    ...
    async fn claim_due_fire(
        &self,
        _request: t3claw_triggers::ClaimDueFireRequest,
    ) -> Result<t3claw_triggers::ClaimDueFireOutcome, t3claw_triggers::TriggerError> {
    ...
    async fn mark_fire_accepted(
        &self,
        _request: t3claw_triggers::FireAcceptedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
    ...
    async fn mark_fire_replayed(
        &self,
        _request: t3claw_triggers::FireReplayedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
    ...
    async fn mark_fire_retryable_failed(
        &self,
        _request: t3claw_triggers::FireRetryableFailedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
    ...
    async fn mark_fire_permanently_failed(
        &self,
        _request: t3claw_triggers::FirePermanentFailedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
    ...
    async fn mark_fire_terminally_failed(
        &self,
        _request: t3claw_triggers::FireTerminalFailedRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
        unreachable!("failing test repository does not update fire results")
    }
    ...
    async fn clear_active_fire(
        &self,
        _request: t3claw_triggers::ClearActiveFireRequest,
    ) -> Result<Option<t3claw_triggers::TriggerRecord>, t3claw_triggers::TriggerError> {
