...
use t3claw_resources::{InMemoryResourceGovernor, ResourceAccount, ResourceTally};
...
async fn reborn_e2e_gate_host_http_consumes_staged_policy_and_secret_once() {
    ...
    obligation_services
        .obligation_handler()
        .satisfy(t3claw_capabilities::CapabilityObligationRequest {
            phase: t3claw_capabilities::CapabilityObligationPhase::Invoke,
            context: &context,
