//! Scoped filesystem service for T3Claw Reborn.
//!
//! `t3claw_filesystem` is the first service crate above
//! `t3claw_host_api`. It resolves runtime-visible [`ScopedPath`] values
