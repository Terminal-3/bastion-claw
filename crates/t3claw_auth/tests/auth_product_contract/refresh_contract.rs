...
use t3claw_auth::{OAuthProviderRefresh, ProviderBackedCredentialAccountService};
...
impl AuthProviderClient for BlockingRefreshProvider {
    async fn exchange_callback(
        &self,
        context: t3claw_auth::OAuthProviderExchangeContext,
        request: t3claw_auth::OAuthProviderCallbackRequest,
    ) -> Result<t3claw_auth::OAuthProviderExchange, AuthProductError> {
