...
use t3claw_host_api::{NetworkMethod, NetworkPolicy, NetworkTarget, ResourceScope};
...
mod tests {
    use super::*;
    use t3claw_host_api::{InvocationId, NetworkScheme, NetworkTargetPattern, TenantId, UserId};
