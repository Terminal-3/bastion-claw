# Agent Map — t3claw_telegram_v2_adapter
...
- Fast local check: `cargo test -p t3claw_telegram_v2_adapter`
- Run `cargo test -p t3claw_product_adapters` when shared DTO assumptions change.
