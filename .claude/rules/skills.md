...
| **Installed** | Downloaded from ClawHub registry or HTTPS skill URL (`~/.t3claw/installed_skills/`, or URL provenance metadata in Reborn scoped skill storage) | Read-only tools only (no shell, file write, HTTP) |
