...
use crate::tools::mcp::config::{LocalMcpAuthConfig, McpServerConfig, NEARAI_MCP_SERVER_NAME};
...
mod tests {
    ...
    use crate::tools::mcp::{
        LocalMcpAuthConfig, McpClient, McpRequest, McpResponse, McpServerConfig, McpTransport,
    };
